...
const GeneratorInterface: React.FC<GeneratorInterfaceProps> = ({ controlProps, previewRef, templateData, apiError }) => {
    const googleKeyIsConfigured = controlProps.userApiKey && controlProps.userApiKey.length > 5;
    ...
    return (
        <div className="container mx-auto">
            ...
            {(!googleKeyIsConfigured || !anyImageKeyIsConfigured) && !controlProps.isBulkGenerating && (
