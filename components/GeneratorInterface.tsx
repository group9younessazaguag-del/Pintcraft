                    ...
                    <div className="flex">
                        ...
                        <div>
                            ...
                            <ul className="list-disc list-inside mt-2 text-sm space-y-1">
                                {!openRouterKeyIsConfigured && <li><strong>OpenRouter API Key (Text):</strong> Required for generating descriptions, keywords, and titles.</li>}
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="ml-3">
                                    ...
                                    <div className="text-sm mt-2 space-y-1">
                                        <p>You've exceeded the free usage limit for your AI API key. This is an issue with your provider account, not the application.</p>
                                        <p>To continue, please check your API provider's billing status or use a different API key.</p>
                                        {apiError.helpLink && (
