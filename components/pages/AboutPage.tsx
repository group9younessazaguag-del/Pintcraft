...
const AboutPage: React.FC<{ content?: string }> = ({ content }) => {

  const defaultContent = (
    <>
      <h1 className="text-4xl font-bold tracking-tight text-slate-800">About Pin4You</h1>
      <p className="lead">
        Welcome to the ultimate tool for social media managers, bloggers, and e-commerce brands looking to supercharge their Pinterest marketing. Pin4You is designed to streamline your content creation process, saving you time and effort while producing beautiful, high-converting pins.
      </p>
