...
import { rewriteTitleAndDescription } from '../../services/googleAi';
...
const DescriptionRewritePage: React.FC<DescriptionRewritePageProps> = ({ openRouterApiKey, onSetOpenRouterApiKey }) => {
    ...
    const handleCsvUpload = (file: File) => {
        ...
        reader.onload = (event) => {
            ...
            if (titleIndex === -1) {
                setApiError({ type: 'generic', message: "CSV must contain a 'Title' column." });
                return;
            }
            ...
            const parsedData: RewriteDataRow[] = lines.slice(1).map(line => {
                ...
                return {
                    ...
                    originalDescription: descIndex !== -1 ? (values[descIndex] || '') : '',
                    rewrittenTitle: '',
    ...
    const handleRewriteDescriptions = async () => {
        ...
        for (let i = 0; i < workingData.length; i++) {
            ...
            try {
                const result = await rewriteTitleAndDescription(
                    openRouterApiKey,
                    openRouterModel,
    ...
    const handleDownloadCsv = () => {
        ...
        const headers = ['Original Title', 'New Title', 'Original Description', 'New Description'];
        ...
        link.setAttribute('download', 'rewritten_titles_descriptions.csv');
        ...
        <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-8">
                ...
                <p className="mt-2 text-lg text-slate-600 max-w-3xl mx-auto">
                    Batch optimize your Titles and Descriptions. Removing salesy terms (Etsy, Buy Now) and boosting SEO.
                </p>
            </div>
                     ...
                     <ControlCard icon={<CsvIcon/>} title="2. Upload CSV">
                        <div className="space-y-4">
                            ...
                            <p className="text-xs text-slate-500">
                                CSV must contain a <strong>Title</strong> column. Description is optional.
                            </p>
                        </div>
                    </ControlCard>
                           ...
                           <table className="w-full text-sm text-left text-slate-500">
                               <thead className="text-xs text-slate-700 uppercase bg-slate-50 sticky top-0">
                                   <tr>
                                       ...
                                       <th scope="col" className="px-4 py-3 w-1/5">Original Title</th>
                                       <th scope="col" className="px-4 py-3 w-1/5 bg-green-50">New Title</th>
